    ...
    <tr>
      ...
      <td style="text-align: left; padding-left: 8px;">
        <ul style="margin-left: 0; padding-left: 16px;">
          ...
          <li><a href="https://rpent.readthedocs.io/en/latest/rst_source/usage/robodojo/index.html">RoboDojo</a> (experimental: dual-arm, three-camera RGB-D, Pi_05, Flash; task discovery, not validated task success; no handover; limited low-Z scripted IK)</li>
        </ul>
      </td>
      <td>
        <ul style="margin-left: 0; padding-left: 16px;">
