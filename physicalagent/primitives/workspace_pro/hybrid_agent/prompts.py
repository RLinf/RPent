...
1. READ MEMORY FIRST. The portable snapshot is in the repo at
   `physicalagent/primitives/workspace_pro/memory_snapshot/`
...
1. read_text_file("physicalagent/primitives/workspace_pro/memory_snapshot/MEMORY.md")
2. read_text_file("physicalagent/primitives/STRICT_HYBRID_GUIDE.md")
3. read_text_file("physicalagent/primitives/workspace_pro/PRO_HYBRID_GUIDE.md")
