...
T_TOTAL=$(date +%s)
launched=0
SKIP_OUTPUT_DIR=${OUTPUT_DIR:-/mnt/public/jxqiu/physicalagent/physicalagent/primitives/workspace_pro/results_claude_p_runs_parallel}
for seed in $SEEDS; do
    ...
    OUTPUT_DIR="${OUTPUT_DIR:-/mnt/public/jxqiu/physicalagent/physicalagent/primitives/workspace_pro/results_claude_p_runs_parallel}" \
