...
`physicalagent/primitives/workspace_pro/hybrid_agent_cc/`
...
```
Driver: `physicalagent/primitives/interactive_driver.py`
...
PERT=physicalagent/primitives/workspace_pro
...
OUTPUT_DIR=physicalagent/primitives/workspace_pro/multi_seed_exp/percep_object_swap_t2 \
