"""task_t0 SOLVE via motion planning (bottom drawer, default-position cabinet): (1) PICK the wine bottle out of the way (PD, close=0.0,
...
# (bottle is off to the left of the bottom drawer; skip removal — verify path is free)
