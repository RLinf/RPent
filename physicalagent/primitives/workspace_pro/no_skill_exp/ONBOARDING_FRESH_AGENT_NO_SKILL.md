...
Working dir: `physicalagent/primitives/workspace_pro/no_skill_exp/`
...
NS=physicalagent/primitives/workspace_pro/no_skill_exp
...
```bash
bash physicalagent/primitives/workspace_pro/no_skill_exp/verify_no_skill.sh
```
