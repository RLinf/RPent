...
from examples.embodiment.primitives.test_hybrid_all_spatial import (
...
def main():
    ...
    out_dir = ("/mnt/public2/zhangyixian/RLinf_agentic/"
               "examples/embodiment/primitives/results_all_spatial_retry")
