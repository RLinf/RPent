...
```
examples/embodiment/primitives/workspace_pro/memory_snapshot/MEMORY.md
```
...
```bash
bash examples/embodiment/primitives/workspace_pro/hybrid_agent_cc/run_perception_cell.sh \
     SUITE TASK SEED
