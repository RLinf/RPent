...
LIBERO_TYPE=pro CUDA_VISIBLE_DEVICES=0 /opt/venv/openpi/bin/python \
  examples/embodiment/primitives/interactive_driver.py \
...
LIBERO_TYPE=pro CUDA_VISIBLE_DEVICES=0 /opt/venv/openpi/bin/python \
  ...
  --out examples/embodiment/primitives/workspace_pro/results_spatial_pert/baseline_pi0_spatial_task_t0_s0.json \
  --save_image_dir examples/embodiment/primitives/workspace_pro/results_spatial_pert/baseline_imgs/task
```
...
LIBERO_TYPE=pro CUDA_VISIBLE_DEVICES=0 /opt/venv/openpi/bin/python \
  ...
  --out examples/embodiment/primitives/workspace_pro/results_spatial_pert/baseline_pi0_spatial_task_t<N>_s0.json
```
