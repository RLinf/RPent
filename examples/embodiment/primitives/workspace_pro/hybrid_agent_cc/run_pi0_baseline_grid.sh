...
#
# Launch detached:
#   nohup bash examples/embodiment/primitives/workspace_pro/hybrid_agent_cc/run_pi0_baseline_grid.sh \
...
run_cell() {
    ...
    LIBERO_TYPE=$LIBERO_TYPE CUDA_VISIBLE_DEVICES=$gpu \
        ...
        "$PYTHON_BIN" examples/embodiment/primitives/pi0_baseline.py \
