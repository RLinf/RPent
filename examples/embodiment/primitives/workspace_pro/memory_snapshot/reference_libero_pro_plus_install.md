...
**Install script**: `examples/embodiment/primitives/workspace_pro/install_libero_pro_plus.sh`

Re-runs LIBERO-Pro + LIBERO-Plus install on top of the **existing** openpi venv (no fresh venv, no torch reinstall). Idempotent:

```bash
bash examples/embodiment/primitives/workspace_pro/install_libero_pro_plus.sh           # both
bash examples/embodiment/primitives/workspace_pro/install_libero_pro_plus.sh --only pro
bash examples/embodiment/primitives/workspace_pro/install_libero_pro_plus.sh --only plus
```
