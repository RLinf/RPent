...
guides) together with its environment server (``env_server.py``). VLA
servers live in :mod:`rpent.robots.components` as shared implementations. The robot registry in :mod:`rpent.robots.base` resolves a
