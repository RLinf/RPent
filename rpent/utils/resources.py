...
def ensure_resources(robot_name: str) -> Path:
    """Sync the robot's resources from HuggingFace each run; set HF_HUB_OFFLINE=1 to use the local copy only. Memory is optional."""
    ...
    try:
        ...
        logger.warning(
            ...
            robot_name, RESOURCES_HF_REPO, exc, resources_dir,
        )
