...
- [2026/08] 🔥 支持 RoboCasa，使用 RLDX-1 作为操作模型。参见 [RoboCasa 安装与 Target50 指南](docs/source-zh/rst_source/usage/robocasa.rst)和 [完整中文文档](https://rpent.readthedocs.io/zh-cn/latest/rst_source/usage/robocasa.html)。
...
[RoboCasa 指南](docs/source-zh/rst_source/usage/robocasa.rst)。
