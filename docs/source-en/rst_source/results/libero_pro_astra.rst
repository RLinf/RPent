...
Each suite has ten tasks (IDs 0–9) and seeds 1–10. Seed 0 is exploration only. S = success; F = failure. All 800 positions are scored once; valid failures are retained. Task rows are sorted by success rate, with their original IDs and seed columns unchanged.
...
`Sanitized public snapshot <https://raw.githubusercontent.com/RLinf/misc/f9ffc9e22a4f4f37079e82a2b78b920b279a3103/rpent/benchmarks/astra-pro-20260915.json>`_.
