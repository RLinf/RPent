...
Complete the LIBERO-PRO installation and model setup in :doc:`../quickstart` first. Start by running an existing plan; plan generation is covered later.
